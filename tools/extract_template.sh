...
xgettext *.php */*.php --copyright-holder='Environment Development Team' --package-name='GLPI - Environment plugin' --package-version='1.7.0' -o locales/glpi.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
